...
- (void)disappear:(NSUInteger)index
{
    for (int i = 0; i < self.submenus.count; ++i)
    {
    ...
    [UIView animateWithDuration:0.2 delay:0.12 options:UIViewAnimationOptionCurveEaseIn animations:^{
        self.magicBgImageView.alpha = 0.7;
    } completion:^(BOOL finished) {
        if (self.selectBlock && index != -1)
        {
