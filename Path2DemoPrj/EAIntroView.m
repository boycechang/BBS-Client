...
- (UIView *)viewForPage:(EAIntroPage *)page atXIndex:(CGFloat *)xIndex {
    ...
    if(page.titleImage) {
        ...
        rect1.size.height = self.frame.size.height - page.titlePositionY - 20;
    ...
    if([page.title length]) {
        NSDictionary *stringAttributes = [NSDictionary dictionaryWithObject:page.titleFont forKey: NSFontAttributeName];
        
        /*
        CGSize labelSize = [page.title boundingRectWithSize:CGSizeMake(self.scrollView.frame.size.width - 20, 100)
                                                    options:NSStringDrawingUsesFontLeading | NSStringDrawingUsesLineFragmentOrigin
                                                 attributes:stringAttributes context:nil].size;
        CGRect titleLabelFrame = CGRectMake(10, self.frame.size.height - page.titlePositionY, self.scrollView.frame.size.width - 20, labelSize.height);
        */
