...
- (void)setProgress:(CGFloat)progress {
    ...
    _progress = (_progress < self.progressToAnimateTo) ?self.progressToAnimateTo: self.progressToAnimateTo;
...
- (void)drawProgressBackground:(CGContextRef)context inRect:(CGRect)rect {
    ...
    CGContextSetFillColorWithColor(context, [UIColor colorWithRed:0.71f green:0.71f blue:0.71f alpha:1.00f].CGColor);
    [roundedRect fill];
