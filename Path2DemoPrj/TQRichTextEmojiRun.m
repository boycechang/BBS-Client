...
{
    NSMutableArray *emojiStringArray = [[NSMutableArray alloc] init];
    for (int i = 1; i <= 73; i++) {
        [emojiStringArray addObject:[NSString stringWithFormat:@"[em%i]", i]];
    }
    for (int i = 0; i <= 41; i++) {
        [emojiStringArray addObject:[NSString stringWithFormat:@"[ema%i]", i]];
    }
    for (int i = 0; i <= 24; i++) {
        [emojiStringArray addObject:[NSString stringWithFormat:@"[emb%i]", i]];
    }
    for (int i = 0; i <= 58; i++) {
        [emojiStringArray addObject:[NSString stringWithFormat:@"[emc%i]", i]];
    }
