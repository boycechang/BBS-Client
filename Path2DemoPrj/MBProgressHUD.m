...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text boundingRectWithSize:bounds.size
    ...
    */
    ...
    /*
    NSDictionary *stringAttributes2 = [NSDictionary dictionaryWithObject:detailsLabel.font forKey: NSFontAttributeName];
